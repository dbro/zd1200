...
Upstream license: BSD Zero Clause License (BSD-0-Clause).
...
The generic local Docker image builds `mksquashfs` and `unsquashfs` from
[`ms264556/ruckus_ap_firmware_mod`](https://github.com/ms264556/ruckus_ap_firmware_mod),
upstream commit `3d9e4add414228eac4091f301e813d14130c3d61`. They are used only
to convert and repack the locally supplied 10.5.1 R600 AP payload into its
patched unsigned form.
